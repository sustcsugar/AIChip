...
> 本 skill 承载节点 D4 的执行工作流。节点完整定义（含人机职责）见 `doc/阶段D-验证/D4-约束随机自动化/D4-约束随机自动化.md`。
...
- 校验脚本：`python scripts/check_tracker.py --node D4`
...
- 节点详章：`doc/阶段D-验证/D4-约束随机自动化/D4-约束随机自动化.md`
