...
> 本 skill 承载节点 D5 的执行工作流。节点完整定义（含人机职责）见 `doc/阶段D-验证/D5-断言与形式化/D5-断言与形式化.md`。
...
- 校验脚本：`python scripts/check_tracker.py --node D5`
...
- 节点详章：`doc/阶段D-验证/D5-断言与形式化/D5-断言与形式化.md`
