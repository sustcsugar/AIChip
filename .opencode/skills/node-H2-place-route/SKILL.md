...
> 本 skill 承载节点 H2 的执行工作流。节点完整定义（含人机职责）见 `doc/阶段H-物理设计/H2-Place与Route/H2-Place与Route.md`。
> 归属 agent：signoff-agent。执行前必须先读 `state/tracker.md` 确认节点处于 in_progress 且前置输入完整。
...
- 校验脚本：`python scripts/check_tracker.py --node H2`
...
- 节点详章：`doc/阶段H-物理设计/H2-Place与Route/H2-Place与Route.md`
