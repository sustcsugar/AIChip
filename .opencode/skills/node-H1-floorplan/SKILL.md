...
> 本 skill 承载节点 H1 的执行工作流。节点完整定义（含人机职责）见 `doc/阶段H-物理设计/H1-Floorplan/H1-Floorplan.md`。
...
- 校验脚本：`python scripts/check_tracker.py --node H1`
...
- 节点详章：`doc/阶段H-物理设计/H1-Floorplan/H1-Floorplan.md`
