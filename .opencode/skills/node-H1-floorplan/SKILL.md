---
name: node-H1-floorplan
description: 物理设计布局规划（可选扩展）。当需要执行或判断节点 H1（Floorplan）的状态、产出或收敛时使用。
---

# Node H1: Floorplan

> 本 skill 承载节点 H1 的执行工作流。节点完整定义（含人机职责）见 `AIFlow/doc/阶段H-物理设计/H1-Floorplan.md`。
...
- 校验脚本：`python AIFlow/scripts/check_tracker.py --node H1`
...
- 节点详章：`AIFlow/doc/阶段H-物理设计/H1-Floorplan.md`
