...
> 本 skill 承载节点 G2 的执行工作流。节点完整定义（含人机职责）见 `doc/阶段G-签核与交付/G2-收敛双签核/G2-收敛双签核.md`。
...
- 校验脚本：`python scripts/check_tracker.py --node G2`
...
- 节点详章：`doc/阶段G-签核与交付/G2-收敛双签核/G2-收敛双签核.md`
