...
> 本 skill 承载节点 G3 的执行工作流。节点完整定义（含人机职责）见 `doc/阶段G-签核与交付/G3-基线归档/G3-基线归档.md`。
...
- 校验脚本：`python scripts/check_tracker.py --node G3`
...
- 节点详章：`doc/阶段G-签核与交付/G3-基线归档/G3-基线归档.md`
