---
name: node-G3-baseline-archive
description: 打 release tag，归档基线。当需要执行或判断节点 G3（基线归档）的状态、产出或收敛时使用。
---

# Node G3: 基线归档

> 本 skill 承载节点 G3 的执行工作流。节点完整定义（含人机职责）见 `AIFlow/doc/阶段G-签核与交付/G3-基线归档.md`。
...
- 校验脚本：`python AIFlow/scripts/check_tracker.py --node G3`
...
- 节点详章：`AIFlow/doc/阶段G-签核与交付/G3-基线归档.md`
