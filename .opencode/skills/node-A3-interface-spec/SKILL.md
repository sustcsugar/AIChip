...
> 本 skill 承载节点 A3 的执行工作流。节点完整定义（含人机职责）见 `doc/阶段A-需求与规格/A3-接口规格/A3-接口规格.md`。
...
- 校验脚本：`python scripts/check_tracker.py --node A3`
...
- 节点详章：`doc/阶段A-需求与规格/A3-接口规格/A3-接口规格.md`
