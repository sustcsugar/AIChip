...
> 本 skill 承载节点 E5 的执行工作流。节点完整定义（含人机职责）见 `doc/阶段E-综合与约束/E5-形式验证LEC/E5-形式验证LEC.md`。
...
- 校验脚本：`python scripts/check_tracker.py --node E5`
...
- 节点详章：`doc/阶段E-综合与约束/E5-形式验证LEC/E5-形式验证LEC.md`
