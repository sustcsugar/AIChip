---
name: node-E5-lec
description: RTL 与网表形式等价性验证。当需要执行或判断节点 E5（形式验证LEC）的状态、产出或收敛时使用。
---

# Node E5: 形式验证LEC

> 本 skill 承载节点 E5 的执行工作流。节点完整定义（含人机职责）见 `AIFlow/doc/阶段E-综合与约束/E5-形式验证LEC.md`。
...
- 校验脚本：`python AIFlow/scripts/check_tracker.py --node E5`
...
- 节点详章：`AIFlow/doc/阶段E-综合与约束/E5-形式验证LEC.md`
