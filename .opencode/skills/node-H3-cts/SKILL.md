---
name: node-H3-cts
description: 时钟树综合（可选扩展）。当需要执行或判断节点 H3（CTS）的状态、产出或收敛时使用。
---

# Node H3: CTS

> 本 skill 承载节点 H3 的执行工作流。节点完整定义（含人机职责）见 `AIFlow/doc/阶段H-物理设计/H3-CTS.md`。
...
- 校验脚本：`python AIFlow/scripts/check_tracker.py --node H3`
...
- 节点详章：`AIFlow/doc/阶段H-物理设计/H3-CTS.md`
