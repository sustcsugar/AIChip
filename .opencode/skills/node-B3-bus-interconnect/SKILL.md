...
> 本 skill 承载节点 B3 的执行工作流。节点完整定义（含人机职责）见 `doc/阶段B-架构与集成规划/B3-总线与互联选型/B3-总线与互联选型.md`。
...
- 校验脚本：`python scripts/check_tracker.py --node B3`
...
- 节点详章：`doc/阶段B-架构与集成规划/B3-总线与互联选型/B3-总线与互联选型.md`
