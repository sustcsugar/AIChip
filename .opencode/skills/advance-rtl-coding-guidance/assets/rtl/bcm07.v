...
//
// Filename    : bcm07.v  (原 DWC_mipi_csi2_host_bcm07.v，模块名已与文件名同步)
// Revision    : $Id: //dwh/mipi_iip/DWC_mipi_csi2_host/main/src/DWC_mipi_csi2_host_bcm07.v#20 $
// Author      : Vikas Gokhale       5/17/04
// Description : bcm07.v Verilog module for DWC_mipi_csi2_host (async FIFO dual-clock wrapper)
//
...
`ifndef SYNTHESIS
  ...
  DWC_mipi_csi2_host_sva05 #(COUNT_WIDTH, PUSH_SYNC) P_SVA_PUSH_GRAY (
        .clk_d(clk_push),
        .rst_d_n(rst_all),
        .data_s(pop_addr_g) );

  DWC_mipi_csi2_host_sva05 #(COUNT_WIDTH, POP_SYNC) P_SVA_POP_GRAY (
        .clk_d(clk_pop),
        .rst_d_n(rst_all),
        .data_s(push_addr_g) );

  DWC_mipi_csi2_host_sva07 #(
  ...
  DWC_mipi_csi2_host_sva12_c P_RESET_PUSH(
    .clk(clk_push),
    .rst_n(rst_push_n),
    .init_n(init_push_n),
    .req_n(push_req_n)
  ...
  DWC_mipi_csi2_host_sva12_c P_RESET_POP(
    .clk(clk_pop),
    .rst_n(rst_pop_n),
    .init_n(init_pop_n),
    .req_n(pop_req_n)
