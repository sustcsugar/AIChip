---
name: node-C6-block-smoke
description: 模块级基础冒烟仿真，验证基本功能通路。当需要执行或判断节点 C6（模块级smoke）的状态、产出或收敛时使用。
---

# Node C6: 模块级smoke

> 本 skill 承载节点 C6 的执行工作流。节点完整定义（含人机职责）见 `AIFlow/doc/阶段C-微架构与RTL/C6-模块级smoke.md`。
...
- 校验脚本：`python AIFlow/scripts/check_tracker.py --node C6`
...
- 节点详章：`AIFlow/doc/阶段C-微架构与RTL/C6-模块级smoke.md`
