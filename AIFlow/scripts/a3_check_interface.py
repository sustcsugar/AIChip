...
用法:
    python AIFlow/scripts/a3_check_interface.py \
        --pin  docs/spec/spec-005-pins.csv \
        --map  docs/spec/spec-005-memory-map.csv \
        --irq  docs/spec/spec-005-irq.csv \
        --uc   docs/spec/spec-002-use-cases.md \
        --spec docs/spec/spec-005-interface-spec.md
