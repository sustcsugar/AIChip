#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""校验 AIFlow/state/state-roadmap.md 的结构（RMP 编号唯一/连续、字段齐全、状态与分类合法）。

用法:
    python AIFlow/scripts/roadmap_check.py            # 校验全部
    python AIFlow/scripts/roadmap_check.py --node RMP-001   # 指定条目
