...
| B | 7 | 1 waiting_review / 6 pending |
| C | 8 | 全部 pending |
| D | 7 | 全部 pending |
| E | 6 | 全部 pending |
| F | 5 | 全部 pending |
...
## B1 系统架构
- 状态: waiting_review
- 前置: A1, A2, A3, A4, A5（spec-v1.0 冻结基线）
- 收敛指标: DoD 自检 6/7 满足（REQ/FS 20/20 承接、BLOCK 14/14 无孤儿、数据流 12 SC/32 UC 全覆盖、时延预算 61ms<100ms/10 周期/≤30 周期、框图↔清单↔端口一致、8 风险有结论）；1 项待人工：架构方案 A/B/C 裁定
- 质量门: 待人工签字（治理回顾完成：详章 §8 修复、ADR-024 AXI4 勘误+CSV 同步、RMP-003/004 登记；R1/R4 数据缺口由 C0/B4 跟踪）
